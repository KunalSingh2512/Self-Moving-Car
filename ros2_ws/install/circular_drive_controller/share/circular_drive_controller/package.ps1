...
colcon_package_source_powershell_script "$env:COLCON_CURRENT_PREFIX\../../build/circular_drive_controller/share/circular_drive_controller/hook/pythonpath_develop.ps1"
